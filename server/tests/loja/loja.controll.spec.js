      ...
      it('deve retornar código HTTP 201 e os dados da loja criada', async () => {
        const { statusCode, body } = await request(app)
          ...
          .send({
            ...
            nome: lojaOnCreateReqData.nome,
            senha: lojaOnCreateReqData.senha,
            imagem: lojaOnCreateReqData.imagem,
            longitude_fixa: lojaOnCreateReqData.longitude_fixa,
            latitude_fixa: lojaOnCreateReqData.latitude_fixa,
          });
